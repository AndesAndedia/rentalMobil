                    ...
                    <div class="row">
                        <nav class="navbar navbar-expand-lg narbar-light">
                            ...
                            <div id="mainNav" class="collapse navbar-collapse tm-bg-white">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#tm-section-3">Rental</a>
                                </li>
                                <li class="nav-item">
        ...
        <div class="tm-page-wrap mx-auto">
            ...
            <div class="tm-container-outer" id="tm-section-3">
                ...
                <div class="tab-content clearfix">
                    ...
                    while ($arr = mysqli_fetch_array($mob1)) {
	                        ?>
                            <div class="tm-recommended-place">
                                <img src="img/tm-img-06.jpg" alt="Image" class="img-fluid tm-recommended-img">
                                <div class="tm-recommended-description-box">
                                    <h3 class="tm-recommended-title"><?php echo $arr['merk']; ?></h3>
                                    <p class="tm-text-highlight"><?php echo $arr['jenis']; ?></p>
                                ...
                                <a href="formrental2.php?nopol=<?php echo $arr['nopol'] ?>" class="tm-recommended-price-box">
                                    <p class="tm-recommended-price">Rp.<?php echo $arr['biaya']; ?></p>
                    ...
                    while ($arr = mysqli_fetch_array($mob2)) {
                    ...
                    while ($arr = mysqli_fetch_array($mob3)) {
	                        ?>
                            <div class="tm-recommended-place">
                                <img src="img/tm-img-06.jpg" alt="Image" class="img-fluid tm-recommended-img">
                                <div class="tm-recommended-description-box">
